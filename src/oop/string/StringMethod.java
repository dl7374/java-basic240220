...
public class StringMethod {
    ...
    public static void main(String[] args) {
        ...
        // charAt(index): 문자열 인덱스에 따른 단일 문자를 변환.
        char c = str.charAt(4);
        System.out.println("4번 인덱스 = " + c);

        // subString(begin, end): 문자열을 범위를 지정해서 부분 추출.
        String ss1 = str.substring(1, 5); // 1번이상 5번 이상
        ...
        // replace(old, new): 기존 문자열 내부의 old값을 무두 찾아서 new 문자열로 일괄 변경
        String java = "자바는 재밌습니다. 자바 커피는 맜있습니다.";
